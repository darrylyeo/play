                ...
                if(keyIsPressed){
                    switch(keyCode){
                        ...
                        case DOWN:
                            ...
                            moveBy.rotate((this.camera.rotateZ + (keyCode - LEFT) * 90) * PI/180);
...
var snowNoes = getImage("khan-academy/seasonal/snownoes.png");
var fatherWinston = getImage("khan-academy/seasonal/father-winston.png");
var hopDeer = getImage("khan-academy/seasonal/hopper-reindeer.png");
...
var house = {
    ...
    draw: function(){
        ...
        for(var i = 0, z = 0; z < house.height + house.roofHeight + 300; z += 125){
            ...
            this.stroke(i % 2 ? color(255) : color(255, 0, 0));
        ...
        //if(this.camera.center.mag() < mag(house.width, house.depth) / 2 + 100){
            ...
            this.open();
                ...
                this.textureMode(NORMALIZED);
                this.beginShape();
                //this.texture(carpet);
                this.vertex(-house.width/2, -house.depth/2, 0, 0);
                this.vertex(house.width/2, -house.depth/2, 1, 0);
                this.vertex(house.width/2, house.depth/2, 1, 1);
                this.vertex(-house.width/2, house.depth/2, 0, 1);
                this.endShape();*/

                this.translate(-house.width/2, -house.depth/2)
                var carpetSize = 10;
                this.noStroke();
                this.colorMode(HSB);
                this.noiseDetail(2, 10);
                this.scale(house.width/carpetSize, house.depth/carpetSize);
                for(var x = 0; x < carpetSize; x++){
                    for(var y = 0; y < carpetSize; y++){
                        var n = this.noise(x * 2, y * 2, x/10 + y/10 + frameCount / 10000);
                        this.fill((n * 20) % 255, 255, 255);
...
this.stroke(255);
this.strokeWeight(2);
this.line(-285.75, -18.75, -285.75, 18.75);
this.line(-285.75, 0, -264.75, 0);
this.line(-264.75, -18.75, -264.75, 18.75);
this.arc(-233.25, 0, 21, 39, -180 * PI/180, 0);
this.line(-243.75, 0, -243.75, 18.75);
this.line(-243.75, 3, -222.75, 3);
this.line(-222.75, 0, -222.75, 18.75);
this.line(-201.75, -18.75, -201.75, 18.75);
this.arc(-201.75, -6.75, 37.5, 24, -90 * PI/180, 90 * PI/180);
this.line(-162.75, -18.75, -162.75, 18.75);
this.arc(-162.75, -6.75, 37.5, 24, -90 * PI/180, 90 * PI/180);
this.line(-123.75, -18.75, -111.75, 3);
this.line(-99.75, -18.75, -111.75, 3);
this.line(-111.75, 18.75, -111.75, 3);
this.line(-54.75, -18.75, -54.75, 18.75);
this.line(-54.75, 0, -33.75, 0);
this.line(-33.75, -18.75, -33.75, 18.75);
this.ellipse(-0.75, 0, 24, 37.5);
this.line(32.25, -18.75, 32.25, 18.75);
this.line(32.25, 18.75, 50.25, 18.75);
this.line(72.75, -18.75, 72.75, 18.75);
this.line(93.75, -18.75, 93.75, 18.75);
this.arc(93.75, 0.75, 39, 39, -90 * PI/180, 90 * PI/180);
this.arc(144.75, 0, 21, 39, -180 * PI/180, 0);
this.line(134.25, 0, 134.25, 18.75);
this.line(134.25, 3, 155.25, 3);
this.line(155.25, 0, 155.25, 18.75);
this.line(176.25, -18.75, 188.25, 3);
this.line(200.25, -18.75, 188.25, 3);
this.line(188.25, 18.75, 188.25, 3);
this.arc(231, -9.75, 19.5, 19.5, 90 * PI/180, 340 * PI/180);
this.arc(231, 9.75, 21, 19.5, -90 * PI/180, 160 * PI/180);
this.line(261.75, -18.75, 261.75, 9);
this.ellipse(261.75, 18.75, 1.5, 1.5);
